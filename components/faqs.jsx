...
export default function FAQs(){
  ...
  return (
    <Slideup percent={'10%'} className=" bg-Blue  radius-box flex justify-center flex-col items-center pb-[4rem] space-y-[1.5rem] pt-[3rem]  w-full" style={{maxWidth:'1300px', margin: '0px auto'}}>
      ...
      <div className="questions flex-col items-center space-y-[1rem] w-full flex justify-center max-w-[1400px] ml-auto mr-auto">
        {/* dropdown-1 */}
        <Slideup delay={.5} percent={'10%'}  className="bg-white rounded-[5px] cursor-pointer border-[1px] w-[95%] tablet:w-[70%]">
        ...
        {/* dropdown-2 */}
        <Slideup delay={.7} percent={'10%'} className="bg-white rounded-[5px] cursor-pointer border-[1px] w-[95%] tablet:w-[70%]">
        ...
        {/* dropdown-3 */}
        <Slideup delay={.9} percent={'10%'} className="bg-white rounded-[5px] cursor-pointer border-[1px] w-[95%] tablet:w-[70%]">
        ...
        {/* dropdown-4 */}
        <Slideup delay={1} percent={'10%'}  className="bg-white rounded-[5px] cursor-pointer border-[1px] w-[95%] tablet:w-[70%]">
