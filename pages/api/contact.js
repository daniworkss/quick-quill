...
//  verify it is a post request to handle errors 
  if (req.method === 'POST'){
     console.log(req.body)
     const data = req.body
     
    //  await transporter.sendMail({
    //     // sender and recieving emails
    //     ...mailOption,
    ...
    //                                     <p >You&apos;ve recieved a new message from your quickQuill website </p>
